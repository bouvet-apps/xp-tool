...
// XP8-only: schemas live under `cms/` (XP7 `site/` is no longer supported).
const SITE_DIR = path.resolve(RESOURCE_DIR, "cms");
const BUILD_SITE_DIR = path.resolve(CODE_DIR, "build/resources/main", "cms");
